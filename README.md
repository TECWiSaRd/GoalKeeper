...
## How to Install
  ...
  6. Your Mac will display an error message "MacOS cannot verify that this app is free from malware". To resolve this, go to System Settings →   Privacy & Security → scroll all the way down → click "Open Anyway", hold control, then click "Open Anyway", or type "xattr -cr /Applications/GoalKeeper.app" in Terminal, then relaunch app.
